...
#### *Cifrado*: 
Para enviar el mensaje (Bob a Alice) primero se debe converte este (mensaje) a un número m, luego se aplica el cifrado usando la clave pública de Alice e.<br />
![image](https://user-images.githubusercontent.com/85766893/175125384-bb8678e0-144e-49a6-840b-574338922658.png)
#### *Descifrado*: 
El mensaje puede ser recuperado, usando d como exponente.<br />
